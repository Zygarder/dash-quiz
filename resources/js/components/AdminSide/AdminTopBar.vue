  ...
  <header class="navbar">
    <div class="navbar-container">
      ...
      <div class="user-section">
        ...
        <router-link v-if="route.path !== '/profile' && showAvatar" to="/profile" class="avatar-link">
        ...
        <button v-else-if="showAvatar" class="minimal-logout" @click="handleLogout" :disabled="loggingOut">
          <svg v-if="!loggingOut" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor"
