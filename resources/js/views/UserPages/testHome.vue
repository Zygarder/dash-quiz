<template>
    <div class="leaderboard">
        ...
        <div class="leaderboard-header">
            ...
            <div v-if="userTestPosition" class="you-pill">
                <span>#{{ userTestPosition }}</span>
                <small>You</small>
            </div>
        </div>
...
// Demo data matching your admin colors
const test_leaderboard = [
    { id: 1, username: 'sarah_j', quiz: 'JavaScript Pro', score: 10, avatarColor: '#1e40af', isYou: false },
    { id: 2, username: 'mike_chen', quiz: 'React Expert', score: 9.5, avatarColor: '#1e3a8a', isYou: false },
]

const userTestPosition = computed(() => {
    const you = test_leaderboard.find(u => u.isYou)
    return you ? test_leaderboard.indexOf(you) + 1 : null
})
